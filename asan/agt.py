...
def asana_report(flag,frm,till):
	...
	data=collections.OrderedDict([("CREATED_AT",time),("MEMBER",assigned),("SOURCE",source),("USER NAME",user_name),("ISSUE DETAILS",issue),("ACTION",actions),("COMMENT",cmnt_lst),("INSTANT RESOLVE",inst_res),("Production Tracker No.",bug_no)])
...
def check_range(frm,till,tckt_obj):
...
if __name__=="__main__":
	print('#'*10,'ASANA REPORT GENERTAOR','#'*10)
	...
	flag = input(">>>")
	print("From :")
	frm=raw_input("Format yyyy-mm-dd")
	print("Till :")
	till=raw_input('Format yyyy-mm-dd')
	if till == '.':
		till_obj=td.today()
	else:
